...
public class Clientback extends AsyncTask<Void, Void, Void> {
	...
	Clientback(String addr, int port, TextView textResponse) {
		Log.d("Socket","Entered Clientback Constructor");
		dstAddress = addr;
		dstPort = port;
